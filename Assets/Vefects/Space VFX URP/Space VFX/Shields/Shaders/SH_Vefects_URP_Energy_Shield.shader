...
Shader "Vefects/SH_Vefects_URP_Energy_Shield"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _MaskNoise01Selector;
			float4 _MaskNoise02Selector;
			float2 _MaskNoise01UVScale;
			float2 _MaskNoise02UVScale;
			float _Cull1;
			float _Src1;
			float _Dst1;
			float _ZTest1;
			float _ZWrite1;
			float _EmissiveMult;
			float _MaskNoise01Falloff;
			float _MaskNoise02Falloff;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 triplanar121 = TriplanarSampling121( _MaskTexture, ( WorldPosition + ( _TimeParameters.x * _DistortionSpeed ) ), ase_worldNormal, _MaskNoise02Falloff, _MaskNoise02UVScale, 1.0, 0 );
				float4 triplanar118 = TriplanarSampling118( _MaskTexture, ( WorldPosition + ( triplanar121.y * _DistortionIntensity ) ), ase_worldNormal, _MaskNoise01Falloff, _MaskNoise01UVScale, 1.0, 0 );
				float dotResult63 = dot( triplanar118 , _MaskNoise01Selector );
				float dotResult115 = dot( triplanar121 , _MaskNoise02Selector );
				float Power73 = IN.ase_texcoord4.z;
				float temp_output_66_0 = pow( saturate( ( saturate( ( saturate( dotResult63 ) * saturate( dotResult115 ) ) ) * IN.ase_color.a ) ) , Power73 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( IN.ase_color * _EmissiveMult ).rgb;
				float Alpha = saturate( temp_output_66_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult63 = dot( triplanar118 , _MaskNoise01Selector );
				float dotResult115 = dot( triplanar121 , _MaskNoise02Selector );
				float Power73 = IN.ase_texcoord3.z;
				float temp_output_66_0 = pow( saturate( ( saturate( ( saturate( dotResult63 ) * saturate( dotResult115 ) ) ) * IN.ase_color.a ) ) , Power73 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 triplanar121 = TriplanarSampling121( _MaskTexture, ( ase_worldPos + ( _TimeParameters.x * _DistortionSpeed ) ), ase_worldNormal, _MaskNoise02Falloff, _MaskNoise02UVScale, 1.0, 0 );
				...
				float dotResult63 = dot( triplanar118 , _MaskNoise01Selector );
				float dotResult115 = dot( triplanar121 , _MaskNoise02Selector );
				float Power73 = IN.ase_texcoord2.z;
				float temp_output_66_0 = pow( saturate( ( saturate( ( saturate( dotResult63 ) * saturate( dotResult115 ) ) ) * IN.ase_color.a ) ) , Power73 );
				

				surfaceDescription.Alpha = saturate( temp_output_66_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float4 triplanar121 = TriplanarSampling121( _MaskTexture, ( ase_worldPos + ( _TimeParameters.x * _DistortionSpeed ) ), IN.normalWS, _MaskNoise02Falloff, _MaskNoise02UVScale, 1.0, 0 );
				float4 triplanar118 = TriplanarSampling118( _MaskTexture, ( ase_worldPos + ( triplanar121.y * _DistortionIntensity ) ), IN.normalWS, _MaskNoise01Falloff, _MaskNoise01UVScale, 1.0, 0 );
				float dotResult63 = dot( triplanar118 , _MaskNoise01Selector );
				float dotResult115 = dot( triplanar121 , _MaskNoise02Selector );
				float Power73 = IN.ase_texcoord2.z;
				float temp_output_66_0 = pow( saturate( ( saturate( ( saturate( dotResult63 ) * saturate( dotResult115 ) ) ) * IN.ase_color.a ) ) , Power73 );
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-2560,1408;Inherit;False;Property;_DistortionSpeed;Distortion Speed;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;119;-2944,0;Inherit;True;Property;_MaskTexture;Mask Texture;4;0;Create;True;0;0;0;False;3;Space(33);Header(Mask Texture);Space(13);False;7e4d3a9b901bb5849a35c75380a437d6;7e4d3a9b901bb5849a35c75380a437d6;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;125;-2305.067,1007.74;Inherit;False;Property;_MaskNoise02UVScale;Mask Noise 02 UV Scale;10;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;129;-2304,1152;Inherit;False;Property;_MaskNoise02Falloff;Mask Noise 02 Falloff;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;132;-2560,640;Inherit;False;Property;_DistortionIntensity;Distortion Intensity;11;0;Create;True;0;0;0;False;0;False;0.1;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;131;-2560,512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;128;-2304,384;Inherit;False;Property;_MaskNoise01Falloff;Mask Noise 01 Falloff;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;130;-2560,256;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector2Node;126;-2304,256;Inherit;False;Property;_MaskNoise01UVScale;Mask Noise 01 UV Scale;7;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector4Node;65;-1920,512;Inherit;False;Property;_MaskNoise01Selector;Mask Noise 01 Selector;5;0;Create;True;0;0;0;False;0;False;1,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;114;-1920,896;Inherit;False;Property;_MaskNoise02Selector;Mask Noise 02 Selector;8;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;68;-128,512;Inherit;False;Property;_OpacityPowerMultiply;Opacity Power Multiply;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;88;-1744,1536;Inherit;False;Property;_Vector1;Vector 1;13;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldPosInputsNode;109;-1232,2944;Float;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;81;-1104,2048;Inherit;False;Property;_SphereMaskRadius;Sphere Mask Radius;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-1104,2176;Inherit;False;Property;_SphereMaskHardness;Sphere Mask Hardness;3;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=0FBCD4B11D9070DC4DE8746DADFF7C72C9EE06B9