...
Shader "Vefects/SH_Vefects_URP_Pyro_Thin_Smoke"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord8.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord8.w;
				...
				float distanceDepth176 = saturate( ( screenDepth176 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
				

				float3 BaseColor = IN.ase_color.rgb;
				...
				float Occlusion = 1;
				float Alpha = saturate( ( IN.ase_color.a * saturate( ( saturate( ( saturate( tex2D( _Flipbook, uv_Flipbook ).r ) - ero146 ) ) * distanceDepth176 ) ) ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord3.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord3.w;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth176 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth176 = saturate( ( screenDepth176 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord4.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord4.w;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord2.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord2.w;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord5.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord5.w;
				float4 ase_screenPosNorm = ScreenPos / ScreenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth176 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth176 = saturate( ( screenDepth176 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( 1.0 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 uv_Flipbook = IN.ase_texcoord.xy * _Flipbook_ST.xy + _Flipbook_ST.zw;
				float ero146 = IN.ase_texcoord.w;
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.a * saturate( ( saturate( ( saturate( tex2D( _Flipbook, uv_Flipbook ).r ) - ero146 ) ) * distanceDepth176 ) ) ) );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.TexturePropertyNode;72;-2048,-128;Inherit;True;Property;_Flipbook;Flipbook;2;0;Create;True;0;0;0;False;3;Space(33);Header(Flipbook);Space(13);False;7cc686bc90b79264a8cbefeb81480102;7cc686bc90b79264a8cbefeb81480102;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;50;507.2599,79.68589;Inherit;False;Property;_Cull1;Cull;7;0;Create;True;0;0;0;True;3;Space(13);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;763.2599,79.68589;Inherit;False;Property;_Src1;Src;8;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;1019.26,79.68589;Inherit;False;Property;_Dst1;Dst;9;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;1531.26,79.68589;Inherit;False;Property;_ZTest1;ZTest;11;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;1275.26,79.68589;Inherit;False;Property;_ZWrite1;ZWrite;10;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-5504,640;Inherit;False;Property;_FlipbookColumns;Flipbook Columns;3;0;Create;True;0;0;0;False;0;False;8;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-5504,768;Inherit;False;Property;_FlipbookRows;Flipbook Rows;4;0;Create;True;0;0;0;False;0;False;8;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-5504,512;Inherit;False;Property;_FlipbookStartFrame;Flipbook Start Frame;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-5504,896;Inherit;False;Property;_FlipbookSpeed;Flipbook Speed;5;0;Create;True;0;0;0;False;0;False;64;64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;92;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Vefects/SH_Vefects_URP_Pyro_Thin_Smoke;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;True;True;1;5;True;_Src1;10;True;_Dst1;2;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;True;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;39;Workflow;0;638489975902210172;Surface;1;638489974111807992;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=76B64D4F72DCCBDC1F2D0D4B3623C9A346CF6403