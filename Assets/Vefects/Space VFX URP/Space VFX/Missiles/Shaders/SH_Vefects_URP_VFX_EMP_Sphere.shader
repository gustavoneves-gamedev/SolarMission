...
Shader "Vefects/SH_Vefects_URP_VFX_EMP_Sphere"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord166 = v.ase_texcoord * _UVScale + float2( 0,0 );
				float randVal224 = v.ase_texcoord.w;
				float2 temp_output_223_0 = ( texCoord166 + randVal224 );
				float2 panner227 = ( 1.0 * _Time.y * ( float2( 0.1,0.1 ) * v.ase_texcoord1.x ) + temp_output_223_0);
				...
				float3 vertexValue = ( v.normalOS * ( tex2Dlod( _NoiseTexture, float4( panner227, 0, 0.0) ).b * v.ase_texcoord1.y ) );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float randVal224 = IN.ase_texcoord3.w;
				float2 temp_output_223_0 = ( texCoord166 + randVal224 );
				...
				float smoothstepResult206 = smoothstep( IN.ase_texcoord3.z , ( IN.ase_texcoord3.z + _EroSmoothness ) , saturate( ( ( tex2DNode172.r * fresnelNode216 ) + tex2DNode173.g ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float randVal224 = IN.ase_texcoord2.w;
				float2 temp_output_223_0 = ( texCoord166 + randVal224 );
				float2 panner169 = ( 1.0 * _Time.y * float2( 0,-0.25 ) + temp_output_223_0);
				float4 tex2DNode172 = tex2D( _NoiseTexture, panner169 );
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				...
				float2 panner219 = ( 1.0 * _Time.y * float2( 0,0.05 ) + ( ( tex2DNode172.r * 0.025 ) + temp_output_223_0 ));
				float4 tex2DNode173 = tex2D( _NoiseTexture, panner219 );
				float smoothstepResult206 = smoothstep( IN.ase_texcoord2.z , ( IN.ase_texcoord2.z + _EroSmoothness ) , saturate( ( ( tex2DNode172.r * fresnelNode216 ) + tex2DNode173.g ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float randVal224 = IN.ase_texcoord.w;
				float2 temp_output_223_0 = ( texCoord166 + randVal224 );
				float2 panner169 = ( 1.0 * _Time.y * float2( 0,-0.25 ) + temp_output_223_0);
				float4 tex2DNode172 = tex2D( _NoiseTexture, panner169 );
				...
				float2 panner219 = ( 1.0 * _Time.y * float2( 0,0.05 ) + ( ( tex2DNode172.r * 0.025 ) + temp_output_223_0 ));
				float4 tex2DNode173 = tex2D( _NoiseTexture, panner219 );
				float smoothstepResult206 = smoothstep( IN.ase_texcoord.z , ( IN.ase_texcoord.z + _EroSmoothness ) , saturate( ( ( tex2DNode172.r * fresnelNode216 ) + tex2DNode173.g ) ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float randVal224 = IN.ase_texcoord1.w;
				float2 temp_output_223_0 = ( texCoord166 + randVal224 );
				float2 panner169 = ( 1.0 * _Time.y * float2( 0,-0.25 ) + temp_output_223_0);
				float4 tex2DNode172 = tex2D( _NoiseTexture, panner169 );
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV216 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode216 = ( 0.0 + _FrScale * pow( max( 1.0 - fresnelNdotV216 , 0.0001 ), _FrPower ) );
				float2 panner219 = ( 1.0 * _Time.y * float2( 0,0.05 ) + ( ( tex2DNode172.r * 0.025 ) + temp_output_223_0 ));
				float4 tex2DNode173 = tex2D( _NoiseTexture, panner219 );
				float smoothstepResult206 = smoothstep( IN.ase_texcoord1.z , ( IN.ase_texcoord1.z + _EroSmoothness ) , saturate( ( ( tex2DNode172.r * fresnelNode216 ) + tex2DNode173.g ) ));
...
Node;AmplifyShaderEditor.Vector2Node;183;-3968,1152;Inherit;False;Property;_UVScale;UV Scale;2;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;217;-1792,816;Inherit;False;Property;_FrScale;Fr Scale;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;221;-2304,1152;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-1792,880;Inherit;False;Property;_FrPower;Fr Power;4;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;237;-1536,384;Inherit;False;Property;_EroSmoothness;Ero Smoothness;5;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
WireConnection;1;5;232;0
ASEEND*/
//CHKSM=B0CCA31A5BC8FB67855DA9745B4050E2891BCE48