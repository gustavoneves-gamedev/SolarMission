...
Shader "Vefects/SH_Vefects_URP_VFX_Energy_Shockwave"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 appendResult163 = (float2(( IN.ase_texcoord3.z * -1.0 ) , 0.0));
				...
				float2 appendResult165 = (float2(( IN.ase_texcoord3.w * -1.0 ) , 0.0));
				float2 panner170 = ( 1.0 * _Time.y * appendResult165 + texCoord166);
				float4 temp_output_175_0 = ( ( tex2D( _LaserTexture, panner169 ) * tex2D( _LaserTexture, panner170 ) ) * 2.0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( IN.ase_color * temp_output_175_0 ) * _EmissiveIntensity ).rgb;
				float Alpha = saturate( ( temp_output_175_0 * IN.ase_color.a ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult163 = (float2(( IN.ase_texcoord2.z * -1.0 ) , 0.0));
				float2 texCoord166 = IN.ase_texcoord2.xy * _UVScale + float2( 0,0 );
				float2 appendResult168 = (float2(( texCoord166.x * 0.25 ) , texCoord166.y));
				float2 panner169 = ( 1.0 * _Time.y * appendResult163 + appendResult168);
				float2 appendResult165 = (float2(( IN.ase_texcoord2.w * -1.0 ) , 0.0));
				float2 panner170 = ( 1.0 * _Time.y * appendResult165 + texCoord166);
				float4 temp_output_175_0 = ( ( tex2D( _LaserTexture, panner169 ) * tex2D( _LaserTexture, panner170 ) ) * 2.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult163 = (float2(( IN.ase_texcoord.z * -1.0 ) , 0.0));
				float2 texCoord166 = IN.ase_texcoord.xy * _UVScale + float2( 0,0 );
				float2 appendResult168 = (float2(( texCoord166.x * 0.25 ) , texCoord166.y));
				float2 panner169 = ( 1.0 * _Time.y * appendResult163 + appendResult168);
				float2 appendResult165 = (float2(( IN.ase_texcoord.w * -1.0 ) , 0.0));
				float2 panner170 = ( 1.0 * _Time.y * appendResult165 + texCoord166);
				float4 temp_output_175_0 = ( ( tex2D( _LaserTexture, panner169 ) * tex2D( _LaserTexture, panner170 ) ) * 2.0 );
				

				surfaceDescription.Alpha = saturate( ( temp_output_175_0 * IN.ase_color.a ) ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 appendResult163 = (float2(( IN.ase_texcoord1.z * -1.0 ) , 0.0));
				float2 texCoord166 = IN.ase_texcoord1.xy * _UVScale + float2( 0,0 );
				float2 appendResult168 = (float2(( texCoord166.x * 0.25 ) , texCoord166.y));
				float2 panner169 = ( 1.0 * _Time.y * appendResult163 + appendResult168);
				float2 appendResult165 = (float2(( IN.ase_texcoord1.w * -1.0 ) , 0.0));
				float2 panner170 = ( 1.0 * _Time.y * appendResult165 + texCoord166);
				float4 temp_output_175_0 = ( ( tex2D( _LaserTexture, panner169 ) * tex2D( _LaserTexture, panner170 ) ) * 2.0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.Vector2Node;183;-3456,0;Inherit;False;Property;_UVScale;UV Scale;1;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;171;-2176,-384;Inherit;True;Property;_LaserTexture;Laser Texture;0;0;Create;True;0;0;0;False;3;Space(33);Header(Laser Texture);Space(13);False;f43bf21eeec22a946b9ca6b5e765f78c;f43bf21eeec22a946b9ca6b5e765f78c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;182;-256,-128;Inherit;False;Property;_EmissiveIntensity;Emissive Intensity;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Energy_Shockwave;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=1624F7B2CC54F8D020014C9E516B8191B1E98022