...
Shader "Vefects/SH_Vefects_URP_VFX_Kinetic_Streak"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float lerpResult185 = lerp( 1.0 , 5.0 , texCoord184.y);
				
				float2 texCoord166 = IN.ase_texcoord3.xy * _UVScale + float2( 0,0 );
				float2 appendResult168 = (float2(( texCoord166.x * 0.25 ) , texCoord166.y));
				float2 panner169 = ( 1.0 * _Time.y * _Noise01PanSpeed + appendResult168);
				float2 panner170 = ( 1.0 * _Time.y * _Noise02PanSpeed + texCoord166);
				float2 texCoord191 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( ( IN.ase_color * lerpResult185 ) * _EmissiveIntensity ).rgb;
				float Alpha = saturate( ( ( pow( ( ( tex2D( _NoiseTexture, panner169 ).r + ( pow( tex2D( _NoiseTexture, panner170 ).r , 2.0 ) * 2.0 ) ) * ( min( ( 1.0 - texCoord191.x ) , texCoord191.x ) * pow( texCoord191.y , 1.5 ) ) ) , 2.0 ) * 5.0 ) * IN.ase_color.a ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner169 = ( 1.0 * _Time.y * _Noise01PanSpeed + appendResult168);
				float2 panner170 = ( 1.0 * _Time.y * _Noise02PanSpeed + texCoord166);
				float2 texCoord191 = IN.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				

				surfaceDescription.Alpha = saturate( ( ( pow( ( ( tex2D( _NoiseTexture, panner169 ).r + ( pow( tex2D( _NoiseTexture, panner170 ).r , 2.0 ) * 2.0 ) ) * ( min( ( 1.0 - texCoord191.x ) , texCoord191.x ) * pow( texCoord191.y , 1.5 ) ) ) , 2.0 ) * 5.0 ) * IN.ase_color.a ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner169 = ( 1.0 * _Time.y * _Noise01PanSpeed + appendResult168);
				float2 panner170 = ( 1.0 * _Time.y * _Noise02PanSpeed + texCoord166);
				float2 texCoord191 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.Vector2Node;183;-3968,-128;Inherit;False;Property;_UVScale;UV Scale;2;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;200;-2944,768;Inherit;False;Property;_Noise02PanSpeed;Noise 02 Pan Speed;4;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;199;-2944,128;Inherit;False;Property;_Noise01PanSpeed;Noise 01 Pan Speed;3;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Kinetic_Streak;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=48F0C0F6861618C7AB1298C80C6F7BA2B22E1C2C