...
Shader "Vefects/SH_Vefects_URP_VFX_Distortion_Shockwave"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult59 = dot( tex2D( _CookieTexture, texCoord96 ) , _CookieTextureChannel );
				float temp_output_100_0 = ( ( IN.ase_color.a * saturate( ( saturate( pow( saturate( dotResult59 ) , _CorePower ) ) * _CoreMultiply ) ) ) * _OverallIntensity );
				...
				float Alpha = ( _Opacity * saturate( ( temp_output_100_0 * 100.0 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( _Opacity * saturate( ( temp_output_100_0 * 100.0 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord96 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float dotResult59 = dot( tex2D( _CookieTexture, texCoord96 ) , _CookieTextureChannel );
				float temp_output_100_0 = ( ( IN.ase_color.a * saturate( ( saturate( pow( saturate( dotResult59 ) , _CorePower ) ) * _CoreMultiply ) ) ) * _OverallIntensity );
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.TexturePropertyNode;74;-4352,0;Inherit;True;Property;_CookieTexture;Cookie Texture;1;0;Create;True;0;0;0;False;3;Space(33);Header(Cookie);Space(13);False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;75;-3456,224;Inherit;False;Property;_CookieTextureChannel;Cookie Texture Channel;2;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-2688,128;Inherit;False;Property;_CorePower;Core Power;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;77;-2688,0;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;103;-2176,128;Inherit;False;Property;_CoreMultiply;Core Multiply;4;0;Create;True;0;0;0;False;0;False;0;20;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-1408,128;Inherit;False;Property;_OverallIntensity;Overall Intensity;5;0;Create;True;0;0;0;False;0;False;0.01;0.01;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;-384,256;Inherit;False;Property;_Opacity;Opacity;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;61;-384,0;Inherit;False;Property;_Debug;Debug;0;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Distortion_Shockwave;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=D3694CE211B5718155861A90937AEDAEF4FD01E9