...
Shader "Vefects/SH_Vefects_URP_Pyro_No_Blend"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord8.z * _FlipbookSpeed;
				...
				float screenDepth121 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth121 = saturate( ( screenDepth121 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( smoothstepResult123 ) );
				float temp_output_127_0 = saturate( ( saturate( tex2DNode83.a ) * distanceDepth121 ) );
				float2 temp_cast_1 = (saturate( tex2DNode83.g )).xx;
				float3 hsvTorgb4_g5 = RGBToHSV( ( ( IN.ase_color * tex2D( _EmissiveLUT, temp_cast_1 ) ) * _EmissiveTint ).rgb );
				...
				float3 BaseColor = ( _SmokeTint * saturate( tex2DNode83.r ) ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = ( temp_output_127_0 * ( ( saturate( hsvTorgb8_g5 ) * IN.ase_texcoord8.w ) * _EmissiveMult ) );
				float3 Specular = temp_cast_3;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = 1;
				float Alpha = saturate( ( temp_output_127_0 * IN.ase_color.a ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord3.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord4.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				...
				float3 BaseColor = ( _SmokeTint * saturate( tex2DNode83.r ) ).rgb;
				float3 Emission = ( temp_output_127_0 * ( ( saturate( hsvTorgb8_g5 ) * IN.ase_texcoord4.w ) * _EmissiveMult ) );
				float Alpha = saturate( ( temp_output_127_0 * IN.ase_color.a ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord2.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord5.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float fbrowsoffset82 = 1.0f / _FlipbookRows;
				// Speed of animation
				float fbspeed82 = IN.ase_texcoord.z * _FlipbookSpeed;
				// UV Tiling (col and row offset)
				float2 fbtiling82 = float2(fbcolsoffset82, fbrowsoffset82);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				...
				surfaceDescription.Alpha = saturate( ( temp_output_127_0 * IN.ase_color.a ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-3200,256;Inherit;False;Property;_FlipbookColumns;Flipbook Columns;6;0;Create;True;0;0;0;False;0;False;8;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-3200,384;Inherit;False;Property;_FlipbookRows;Flipbook Rows;7;0;Create;True;0;0;0;False;0;False;8;4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;80;-3200,128;Inherit;False;Property;_FlipbookStartFrame;Flipbook Start Frame;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;79;-3200,512;Inherit;False;Property;_FlipbookSpeed;Flipbook Speed;8;0;Create;True;0;0;0;False;0;False;64;64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;72;-2560,-256;Inherit;True;Property;_Flipbook;Flipbook;5;0;Create;True;0;0;0;False;3;Space(33);Header(Flipbook);Space(13);False;54fa908065a6dc6428a7405ad5dedcf9;54fa908065a6dc6428a7405ad5dedcf9;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;124;-1664,640;Inherit;False;Property;_DFEroSS;DF Ero SS;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;125;-1664,736;Inherit;False;Property;_DFEroSSS;DF Ero SSS;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;113;-1536,1024;Inherit;True;Property;_EmissiveLUT;Emissive LUT;10;0;Create;True;0;0;0;False;3;Space(33);Header(Emissive);Space(13);False;-1;f57767c513f8ca64dbef45a46c4349a2;f57767c513f8ca64dbef45a46c4349a2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;117;-640,1168;Inherit;False;Property;_EmissiveHueShift;Emissive Hue Shift;13;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;118;-896,1152;Inherit;False;Property;_EmissiveTint;Emissive Tint;12;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-256,896;Inherit;False;Property;_EmissiveMult;Emissive Mult;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;92;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Vefects/SH_Vefects_URP_Pyro_No_Blend;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;True;True;1;5;True;_Src1;10;True;_Dst1;2;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;1;True;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;39;Workflow;0;638489975902210172;Surface;1;638489974111807992;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;92;2;130;0
WireConnection;92;9;107;0
WireConnection;92;4;108;0
WireConnection;92;6;67;0
ASEEND*/
//CHKSM=C5C3C89FDF8ABD2D89E0230E6DF959B7F0C105B7