...
Shader "Vefects/SH_Vefects_URP_Lens_Flare"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float cos80 = cos( ( _TimeParameters.x * 2.0 ) );
				float sin80 = sin( ( _TimeParameters.x * 2.0 ) );
				float2 rotator80 = mul( texCoord85 - _Vector0 , float2x2( cos80 , -sin80 , sin80 , cos80 )) + _Vector0;
				float4 tex2DNode72 = tex2D( _LensFlareTexture, rotator80 );
				float cos84 = cos( ( _TimeParameters.x * -1.0 ) );
				float sin84 = sin( ( _TimeParameters.x * -1.0 ) );
				float2 rotator84 = mul( texCoord85 - _Vector0 , float2x2( cos84 , -sin84 , sin84 , cos84 )) + _Vector0;
				float4 tex2DNode78 = tex2D( _LensFlareTexture, rotator84 );
				float2 uv_LensFlareTexture = IN.ase_texcoord3.xy * _LensFlareTexture_ST.xy + _LensFlareTexture_ST.zw;
				...
				float3 Color = ( ( IN.ase_color * tex2D( _LUT, temp_cast_0 ) ) * _EmissiveMult ).rgb;
				float Alpha = saturate( temp_output_77_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 rotator84 = mul( texCoord85 - _Vector0 , float2x2( cos84 , -sin84 , sin84 , cos84 )) + _Vector0;
				float4 tex2DNode78 = tex2D( _LensFlareTexture, rotator84 );
				float2 uv_LensFlareTexture = IN.ase_texcoord2.xy * _LensFlareTexture_ST.xy + _LensFlareTexture_ST.zw;
				float4 tex2DNode79 = tex2D( _LensFlareTexture, uv_LensFlareTexture );
				float temp_output_77_0 = saturate( ( ( tex2DNode72.r + tex2DNode78.g ) + tex2DNode79.b ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 rotator84 = mul( texCoord85 - _Vector0 , float2x2( cos84 , -sin84 , sin84 , cos84 )) + _Vector0;
				float4 tex2DNode78 = tex2D( _LensFlareTexture, rotator84 );
				float2 uv_LensFlareTexture = IN.ase_texcoord.xy * _LensFlareTexture_ST.xy + _LensFlareTexture_ST.zw;
				float4 tex2DNode79 = tex2D( _LensFlareTexture, uv_LensFlareTexture );
				float temp_output_77_0 = saturate( ( ( tex2DNode72.r + tex2DNode78.g ) + tex2DNode79.b ) );
				

				surfaceDescription.Alpha = saturate( temp_output_77_0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 rotator84 = mul( texCoord85 - _Vector0 , float2x2( cos84 , -sin84 , sin84 , cos84 )) + _Vector0;
				float4 tex2DNode78 = tex2D( _LensFlareTexture, rotator84 );
				float2 uv_LensFlareTexture = IN.ase_texcoord1.xy * _LensFlareTexture_ST.xy + _LensFlareTexture_ST.zw;
				float4 tex2DNode79 = tex2D( _LensFlareTexture, uv_LensFlareTexture );
				float temp_output_77_0 = saturate( ( ( tex2DNode72.r + tex2DNode78.g ) + tex2DNode79.b ) );
...
Node;AmplifyShaderEditor.TexturePropertyNode;71;-2048,128;Inherit;True;Property;_LensFlareTexture;Lens Flare Texture;7;0;Create;True;0;0;0;False;3;Space(33);Header(Lens Flare);Space(13);False;c5acc98b39e0aca469517546eb228d2c;c5acc98b39e0aca469517546eb228d2c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;50;507.2599,79.68589;Inherit;False;Property;_Cull1;Cull;2;0;Create;True;0;0;0;True;3;Space(13);Header(AR);Space(13);False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;763.2599,79.68589;Inherit;False;Property;_Src1;Src;3;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;1019.26,79.68589;Inherit;False;Property;_Dst1;Dst;4;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;53;1531.26,79.68589;Inherit;False;Property;_ZTest1;ZTest;6;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;1275.26,79.68589;Inherit;False;Property;_ZWrite1;ZWrite;5;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;73;-896,-256;Inherit;True;Property;_LUT;LUT;1;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;0706623d7d003ef46bfe4b3dc3ca0dee;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F3F7093C38A8FADB237ED6203595AE64BA6714F0