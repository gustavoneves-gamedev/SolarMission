...
Shader "Vefects/SH_Vefects_URP_Unlit_Particle_Adv_01"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 temp_output_43_0 = ( IN.ase_color * _Tint );
				...
				float4 temp_cast_0 = (IN.ase_texcoord4.z).xxxx;
				...
				float4 temp_output_45_0 = saturate( ( ( IN.ase_color.a * saturate( ( ( tex2DNode27 - temp_cast_0 ) / _ErosionSmoothness ) ) ) * saturate( ( pow( tex2D( _CutoutTexture, uv_CutoutTexture ) , temp_cast_1 ) * _CutoutMult ) ) ) );
				...
				float screenDepth58 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth58 = abs( ( screenDepth58 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFade ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (IN.ase_texcoord3.z).xxxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (IN.ase_texcoord1.z).xxxx;
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 lerpResult24 = lerp( float2( 0,0 ) , ( ( (tex2D( _MainTexture1, panner14 )).rg + -0.5 ) * 2.0 ) , _UVDLerp);
				float4 tex2DNode27 = tex2D( _MainTexture, ( panner25 + lerpResult24 ) );
				float4 temp_cast_0 = (IN.ase_texcoord2.z).xxxx;
...
Node;AmplifyShaderEditor.SamplerNode;27;-2602.512,512.2148;Inherit;True;Property;_MainTexture;Main Texture;1;0;Create;True;0;0;0;False;3;Space(13);Header(Main Texture);Space(33);False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1962.513,1024.215;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;6;0;Create;True;0;0;0;False;0;False;0.17;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;40;-2602.512,-127.7851;Inherit;False;Property;_Tint;Tint;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_Unlit_Particle_Adv_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;2;5;True;_Src1;10;True;_Dst1;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638255503152939265;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=14A58943CB21FE4D75B83BDF0A3F9A2A46D7150D