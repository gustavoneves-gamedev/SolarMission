	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float fresnelNdotV1_g1 = dot( float3(dot(tanToWorld0,tanNormal1_g1), dot(tanToWorld1,tanNormal1_g1), dot(tanToWorld2,tanNormal1_g1)), ase_worldViewDir );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace) : SV_TARGET
			{
				...
				float2 texCoord150 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord103 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult105 = (float2(( texCoord103.x * 0.25 ) , texCoord103.y));
				float2 texCoord69 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner72 = ( 1.0 * _Time.y * _Noise01Pan + ( texCoord69 * _Noise01Scale ));
				float2 temp_output_106_0 = ( appendResult105 + ( tex2D( _Texture0, panner72 ).r * 0.005 ) );
				float2 panner107 = ( 1.0 * _Time.y * float2( 0.005,0 ) + temp_output_106_0);
				float2 panner109 = ( 1.0 * _Time.y * float2( 0.0025,0 ) + temp_output_106_0);
				float2 texCoord70 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner73 = ( 1.0 * _Time.y * _Noise02Pan + ( texCoord70 * _Noise02Scale ));
				...
				float2 panner92 = ( 1.0 * _Time.y * float2( 0.2,0 ) + ( texCoord89 * _VerticalMaskUVScale ));
				float temp_output_116_0 = saturate( max( saturate( ( tex2D( _StarNoisesTexture, panner107 ).r * tex2D( _StarNoisesTexture, panner109 ).r ) ) , saturate( ( tex2D( _StarNoisesTexture, ( ( tex2D( _Texture0, panner73 ).r * 0.025 ) + panner97 ) ).g - saturate( ( 1.0 - pow( tex2D( _StarNoisesTexture, ( panner92 + _VerticalMaskUVOffset ) ).b , 1.5 ) ) ) ) ) ) );
				float2 texCoord71 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner74 = ( 1.0 * _Time.y * _Noise03Pan + ( texCoord71 * _Noise03Scale ));
				float PerlinForMult84 = saturate( pow( tex2D( _Texture0, panner74 ).r , 2.0 ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Rays;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=B5FEA1BAE966D858489A2FAA0D4C0AA33989D537