...
Shader "Vefects/SH_Vefects_URP_VFX_Black_Hole_Accretion_Disk"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Color;
			float4 _BlackHoleNoise02Selector;
			float4 _BlackHoleNoise01Selector;
			float2 _BlackHoleNoise01Scale;
			float2 _BlackHoleNoise02Scale;
			float2 _BlackHoleNoise02Pan;
			float2 _BlackHoleNoise01Pan;
			float _WPOStrength;
			float _Src;
			float _NoiseSSEroSmooth;
			float _NoiseSSEro;
			float _Cull;
			float _ZTest;
			float _ZWrite;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 texCoord103 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner104 = ( 1.0 * _Time.y * _BlackHoleNoise01Pan + ( texCoord103 * _BlackHoleNoise01Scale ));
				float dotResult98 = dot( tex2Dlod( _BlackHoleNoise, float4( panner104, 0, 0.0) ) , _BlackHoleNoise01Selector );
				float2 texCoord105 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner106 = ( 1.0 * _Time.y * _BlackHoleNoise02Pan + ( texCoord105 * _BlackHoleNoise02Scale ));
				...
				float3 vertexValue = ( ( ( temp_output_85_0 * length( ase_objectScale ) ) * v.normalOS ) * ( _WPOStrength / 1000000.0 ) );
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( ( _Color * pow( texCoord66.y , _VMaskPower ) ) * IN.ase_color.r ) * _EmissiveStrength ).rgb;
				float Alpha = saturate( ( IN.ase_color.r * saturate( pow( saturate( ( texCoord66.y * temp_output_85_0 ) ) , 2.0 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( IN.ase_color.r * saturate( pow( saturate( ( texCoord66.y * temp_output_85_0 ) ) , 2.0 ) ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord66 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 texCoord103 = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner104 = ( 1.0 * _Time.y * _BlackHoleNoise01Pan + ( texCoord103 * _BlackHoleNoise01Scale ));
				float dotResult98 = dot( tex2D( _BlackHoleNoise, panner104 ) , _BlackHoleNoise01Selector );
...
Node;AmplifyShaderEditor.Vector2Node;111;-4480,1792;Inherit;False;Property;_BlackHoleNoise01Scale;Black Hole Noise 01 Scale;5;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;112;-4480,2176;Inherit;False;Property;_BlackHoleNoise02Scale;Black Hole Noise 02 Scale;8;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;109;-4096,2176;Inherit;False;Property;_BlackHoleNoise02Pan;Black Hole Noise 02 Pan;9;0;Create;True;0;0;0;False;0;False;-0.002,0.002;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;108;-4096,1792;Inherit;False;Property;_BlackHoleNoise01Pan;Black Hole Noise 01 Pan;6;0;Create;True;0;0;0;False;0;False;-0.001,0.001;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;94;-4224,1408;Inherit;True;Property;_BlackHoleNoise;Black Hole Noise;3;0;Create;True;0;0;0;False;3;Space(33);Header(Black Hole Noise);Space(13);False;d55e5b65bce22ab4da9a14a757120624;d55e5b65bce22ab4da9a14a757120624;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;101;-3328,2176;Inherit;False;Property;_BlackHoleNoise02Selector;Black Hole Noise 02 Selector;7;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;100;-3328,1792;Inherit;False;Property;_BlackHoleNoise01Selector;Black Hole Noise 01 Selector;4;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;86;-2048,1920;Inherit;False;Property;_NoiseSSEro;Noise SS Ero;10;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;-2048,2048;Inherit;False;Property;_NoiseSSEroSmooth;Noise SS Ero Smooth;11;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;84;-256,2304;Inherit;False;Property;_WPOStrength;WPO Strength;12;0;Create;True;0;0;0;False;3;Space(33);Header(WPO);Space(13);False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;53;640,0;Inherit;False;Property;_Src;Src;14;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;896,0;Inherit;False;Property;_Dst;Dst;15;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;1152,0;Inherit;False;Property;_ZWrite;ZWrite;16;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;1408,0;Inherit;False;Property;_ZTest;ZTest;17;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;384,0;Inherit;False;Property;_Cull;Cull;13;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-256,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-272,-128;Inherit;False;Property;_EmissiveStrength;EmissiveStrength;1;0;Create;True;0;0;0;False;0;False;50;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;64;-1792,0;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1152,512;Inherit;False;Property;_VMaskPower;V Mask Power;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Black_Hole_Accretion_Disk;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
WireConnection;1;5;83;0
ASEEND*/
//CHKSM=D41B98BCA670FF17A74484A64305E7B657597CA1