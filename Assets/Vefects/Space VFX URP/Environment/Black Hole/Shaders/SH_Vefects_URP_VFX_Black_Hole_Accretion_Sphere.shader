...
Shader "Vefects/SH_Vefects_URP_VFX_Black_Hole_Accretion_Sphere"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _BHNoiseFrBias;
			float _BHNoiseFrScale;
			float _BHNoiseFrPower;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( ( _Color * saturate( ( 1.0 - saturate( fresnelNode140 ) ) ) ) * _EmissiveStrength ).rgb;
				float Alpha = saturate( ( temp_output_134_0 * IN.ase_color.r ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( temp_output_134_0 * IN.ase_color.r ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV125 = dot( IN.normalWS, ase_worldViewDir );
				float fresnelNode125 = ( _BHNoiseFrBias + _BHNoiseFrScale * pow( 1.0 - fresnelNdotV125, _BHNoiseFrPower ) );
				float temp_output_130_0 = ( 1.0 - saturate( fresnelNode125 ) );
				float temp_output_117_0 = ( pow( ( ( temp_output_130_0 * 3.0 ) + temp_output_130_0 ) , 2.0 ) * 2.0 );
				float2 appendResult120 = (float2(temp_output_117_0 , temp_output_117_0));
...
/*ASEBEGIN
Version=19303
Node;AmplifyShaderEditor.RangedFloatNode;128;-4736,1152;Inherit;False;Property;_BHNoiseFrBias;BH Noise Fr Bias;9;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;126;-4736,1280;Inherit;False;Property;_BHNoiseFrScale;BH Noise Fr Scale;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;127;-4736,1408;Inherit;False;Property;_BHNoiseFrPower;BH Noise Fr Power;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;94;-2944,640;Inherit;True;Property;_BlackHoleNoise;Black Hole Noise;5;0;Create;True;0;0;0;False;3;Space(33);Header(Black Hole Noise);Space(13);False;d55e5b65bce22ab4da9a14a757120624;d55e5b65bce22ab4da9a14a757120624;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;100;-2048,1024;Inherit;False;Property;_BlackHoleNoise01Selector;Black Hole Noise 01 Selector;6;0;Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;53;640,0;Inherit;False;Property;_Src;Src;11;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;896,0;Inherit;False;Property;_Dst;Dst;12;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;1152,0;Inherit;False;Property;_ZWrite;ZWrite;13;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;1408,0;Inherit;False;Property;_ZTest;ZTest;14;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;51;384,0;Inherit;False;Property;_Cull;Cull;10;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-256,0;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;139;-1792,256;Inherit;False;Property;_ColorFrBias;Color Fr Bias;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;138;-1792,384;Inherit;False;Property;_ColorFrScale;Color Fr Scale;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;137;-1792,512;Inherit;False;Property;_ColorFrPower;Color Fr Power;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-256,-128;Inherit;False;Property;_EmissiveStrength;EmissiveStrength;0;0;Create;True;0;0;0;False;0;False;50;50;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;64;-1792,0;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;3;Space(33);Header(Color);Space(13);False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Black_Hole_Accretion_Sphere;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;1;5;True;_Src;10;True;_Dst;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;True;_ZWrite;True;3;True;_ZTest;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;21;Surface;1;638489048301038786;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Cast Shadows;0;638489028874023326;  Use Shadow Threshold;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=095135D984CD13B9D19E0586B32739F08AEBE98F