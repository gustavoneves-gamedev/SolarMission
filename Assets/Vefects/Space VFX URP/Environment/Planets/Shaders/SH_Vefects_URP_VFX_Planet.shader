...
Shader "Vefects/SH_Vefects_URP_VFX_Planet"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _TerrainLUTRange;
			float _EmissiveStrength;
			float _NormalIntensity;
			float _EmissiveMaxSmoothstep;
			float _EmissiveMinSmoothstep;
			float _AtmosphereDensity;
			float _AtmosphereFresnelPower;
			float _AtmosphereFresnelBias;
			float _Specular;
			float _CloudsMultiply;
			float _CloudsPower;
			float _CloudsSoftness;
			float _CloudsCoverage;
			float _TerrainLUTOffset;
			float _AtmosphereFresnelScale;
			float _Smoothness;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord25 = input.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode14 = tex2D( _TerrainTexture, texCoord25 );
				float2 temp_cast_0 = (( ( tex2DNode14.r * _TerrainLUTRange ) + _TerrainLUTOffset )).xx;
				float temp_output_91_0 = ( 1.0 - _CloudsCoverage );
				float2 uv_CloudsTexture = input.ase_texcoord9.xy * _CloudsTexture_ST.xy + _CloudsTexture_ST.zw;
				...
				float fresnelNdotV20 = dot( WorldNormal, ase_viewDirWS );
				...
				float3 lerpResult62 = lerp( float3(0,0,1) , UnpackNormalScale( tex2D( _NormalTexture, uv_NormalTexture ), 1.0f ) , _NormalIntensity);
				...
				float3 BaseColor = lerpResult98.rgb;
				float3 Normal = lerpResult62;
				float3 Emission = ( ( tex2D( _EmissiveLUT, temp_cast_2 ) * _EmissiveStrength ) * smoothstepResult95 ).rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord25 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode14 = tex2D( _TerrainTexture, texCoord25 );
				float2 temp_cast_0 = (( ( tex2DNode14.r * _TerrainLUTRange ) + _TerrainLUTOffset )).xx;
				float temp_output_91_0 = ( 1.0 - _CloudsCoverage );
				float2 uv_CloudsTexture = input.ase_texcoord4.xy * _CloudsTexture_ST.xy + _CloudsTexture_ST.zw;
				float smoothstepResult90 = smoothstep( temp_output_91_0 , ( temp_output_91_0 + _CloudsSoftness ) , tex2D( _CloudsTexture, uv_CloudsTexture ).r);
				float4 lerpResult80 = lerp( tex2D( _TerrainLUT, temp_cast_0 ) , _CloudsColor , saturate( ( saturate( pow( smoothstepResult90 , _CloudsPower ) ) * _CloudsMultiply ) ));
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
				float3 ase_worldNormal = input.ase_texcoord5.xyz;
				float fresnelNdotV20 = dot( ase_worldNormal, ase_viewDirWS );
				float fresnelNode20 = ( _AtmosphereFresnelBias + _AtmosphereFresnelScale * pow( max( 1.0 - fresnelNdotV20 , 0.0001 ), _AtmosphereFresnelPower ) );
				float4 lerpResult72 = lerp( lerpResult80 , _AtmosphereColor , saturate( ( fresnelNode20 * _AtmosphereDensity ) ));
				float smoothstepResult95 = smoothstep( _EmissiveMinSmoothstep , _EmissiveMaxSmoothstep , tex2DNode14.r);
				float4 lerpResult98 = lerp( lerpResult72 , float4( 0,0,0,0 ) , smoothstepResult95);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 texCoord25 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode14 = tex2D( _TerrainTexture, texCoord25 );
				float2 temp_cast_0 = (( ( tex2DNode14.r * _TerrainLUTRange ) + _TerrainLUTOffset )).xx;
				float temp_output_91_0 = ( 1.0 - _CloudsCoverage );
				float2 uv_CloudsTexture = input.ase_texcoord2.xy * _CloudsTexture_ST.xy + _CloudsTexture_ST.zw;
				float smoothstepResult90 = smoothstep( temp_output_91_0 , ( temp_output_91_0 + _CloudsSoftness ) , tex2D( _CloudsTexture, uv_CloudsTexture ).r);
				float4 lerpResult80 = lerp( tex2D( _TerrainLUT, temp_cast_0 ) , _CloudsColor , saturate( ( saturate( pow( smoothstepResult90 , _CloudsPower ) ) * _CloudsMultiply ) ));
				float3 ase_viewVectorWS = ( _WorldSpaceCameraPos.xyz - WorldPosition );
				float3 ase_viewDirWS = normalize( ase_viewVectorWS );
...
Node;AmplifyShaderEditor.SamplerNode;66;-768,1152;Inherit;True;Property;_NormalTexture;Normal Texture;21;0;Create;True;0;0;0;False;3;Space(33);Header(Normal);Space(13);False;-1;2d3291a140aecdd4a9c8ddd35348ffb0;2d3291a140aecdd4a9c8ddd35348ffb0;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;99;-1792,768;Inherit;True;Property;_EmissiveLUT;Emissive LUT;17;0;Create;True;0;0;0;False;3;Space(33);Header(Emissive);Space(13);False;-1;8ad064702fd0b194c8a1efd6835ee789;8ad064702fd0b194c8a1efd6835ee789;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;13;-3072,-128;Inherit;True;Property;_TerrainLUT;Terrain LUT;3;0;Create;True;0;0;0;False;0;False;-1;eefdc5db1c4430941b5062bc7d88bb38;eefdc5db1c4430941b5062bc7d88bb38;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;14;-3840,256;Inherit;True;Property;_TerrainTexture;Terrain Texture;2;0;Create;True;0;0;0;False;3;Space(33);Header(Terrain);Space(13);False;-1;ec31af15634d9374a9dca49fade8e944;ec31af15634d9374a9dca49fade8e944;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;82;-2560,-384;Inherit;False;Property;_CloudsColor;Clouds Color;12;0;Create;True;0;0;0;False;0;False;0.8553458,1,0.9881043,0;0.854902,1,0.9882353,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;71;-1024,-1152;Inherit;False;Property;_AtmosphereColor;Atmosphere Color;6;0;Create;True;0;0;0;False;3;Space(33);Header(Atmosphere);Space(13);False;0.553459,0.9314483,1,0;0.5529412,0.9333333,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;52;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Vefects/SH_Vefects_URP_VFX_Planet;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;45;Lighting Model;0;0;Workflow;0;638489271803605530;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;1;0;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Receive SSAO;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;11;False;True;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;53;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;54;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;55;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;59;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;60;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;102;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;52;2;101;0
WireConnection;52;9;68;0
WireConnection;52;4;69;0
ASEEND*/
//CHKSM=D6F6A36496447F46E22C039E8228FA0010CA8B1E